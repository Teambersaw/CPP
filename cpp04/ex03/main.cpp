...
/*   Updated: 2022/11/28 00:43:50 by jrossett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	std::cout << "Try to learn two more materia but it's impossible" << std::endl;
	src->learnMateria(new Cure());
	src->learnMateria(new Cure());
	...
	std::cout << "create and equip Ice in 1/3 emplacement" << std::endl; 
	tmp2 = src->createMateria("cure");
	me->equip(tmp2);

	std::cout << "create and equip Ice in 2/3 emplacement" << std::endl; 
	tmp3 = src->createMateria("ice");
	me->equip(tmp3);

	std::cout << "create and equip Ice in 3/3 emplacement" << std::endl; 
